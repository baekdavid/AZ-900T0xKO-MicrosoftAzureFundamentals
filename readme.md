# AZ-900T00 및 AZ-900T01: Microsoft Azure 기초 과정
...
- Microsoft는 이러한 과정을 지원하기 위해 과정 콘텐츠를 자주 업데이트하여 과정에 사용된 Azure 서비스를 최신 상태로 유지할 것입니다.  또한 GitHub에 랩 명령을 게시하여 과정 작성자와 MCT 간의 공개적인 기고를 지원함으로써 Azure 플랫폼의 변경에 따라 콘텐츠를 최신 상태로 유지합니다.
